...
const defaultEmail = "face-message.com"
const defaultPassword = "zarusova123!@#"
...
<div className="font-[sans-serif] text-[#333] bg-green-100">
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div className="md:max-w-md w-full sm:px-6 py-4">
            <form onSubmit={handleSubmit} >
              <div className="mb-12">
                <h3 className="text-3xl font-extrabold">Facemessage</h3>
                <p className="text-sm mt-4 ">アカウントをお持ちではありません <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">ここに登録</a></p>
              </div>
              <div>
                <label className="text-xs block mb-2">ユーザー名</label>
                <div className="relative flex items-center">
                  <input onChange={handleEmail} value={defaultEmail}  name="email" type="text" required className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="User" />
              ...
              <div className="mt-8">
                <label className="text-xs block mb-2">パスワード</label>
                <div className="relative flex items-center">
                  <input onChange={handlePswd} value={defaultPassword} name="password" type="password" required className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter password" />
              ...
              <div className="mt-12">
                <input className="bg-[#002D74] w-full h-[60px] text-[30px] text-white rounded-full" type="submit" required value="ログイン" />
              </div>

              <p className="my-8 text-sm text-gray-400 text-center">または続行してください</p>
